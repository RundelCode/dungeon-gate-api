...
export class UpdateSpellDto {
    ...
    @IsOptional() @IsString() casting_time?: string;
    @IsOptional() @IsString() range?: string;
    @IsOptional() @IsString() components?: string;
    @IsOptional() @IsString() duration?: string;
    @IsOptional() @IsBoolean() is_concentration?: boolean;
    @IsOptional() @IsBoolean() is_ritual?: boolean;
    @IsOptional() @IsString() attack_type?: string;
    @IsOptional() @IsString() save_ability?: string;
